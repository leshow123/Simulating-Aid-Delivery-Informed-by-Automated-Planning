...
struct EsterelPlanEdge_
{
  ...
  (void)_alloc;
   ...
   typedef int8_t _edge_type_type;
...
struct MD5Sum< ::rosplan_dispatch_msgs::EsterelPlanEdge_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x1d2c55d97ec59475ULL;
  static const uint64_t static_value2 = 0x80a42b9057d254ceULL;
};
...
struct Printer< ::rosplan_dispatch_msgs::EsterelPlanEdge_<ContainerAllocator> >
{
  ...
  {
    s << indent << "edge_type: ";
    Printer<int8_t>::stream(s, indent + "  ", v.edge_type);
    s << indent << "edge_id: ";
