...
if("TRUE" STREQUAL "TRUE")
  set(rosplan_interface_movebase_SOURCE_PREFIX /home/olumide/TDDE05/catkin_ws/src/rosplan/rosplan_interface_movebase)
  set(rosplan_interface_movebase_DEVEL_PREFIX /home/olumide/TDDE05/catkin_ws/devel)
  ...
  set(rosplan_interface_movebase_INSTALL_PREFIX /home/olumide/TDDE05/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosplan_interface_movebase' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/olumide/TDDE05/catkin_ws/src/rosplan/rosplan_interface_movebase/${idir}'.  ${_report}")
    endif()
