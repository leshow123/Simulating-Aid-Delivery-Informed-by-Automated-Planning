...
if("TRUE" STREQUAL "TRUE")
  set(rosplan_planning_system_SOURCE_PREFIX /home/olumide/TDDE05/catkin_ws/src/rosplan/rosplan_planning_system)
  set(rosplan_planning_system_DEVEL_PREFIX /home/olumide/TDDE05/catkin_ws/devel)
  ...
  set(rosplan_planning_system_INSTALL_PREFIX /home/olumide/TDDE05/catkin_ws/install)
...
if(NOT "/home/olumide/TDDE05/catkin_ws/src/rosplan/rosplan_planning_system/include;/home/olumide/TDDE05/catkin_ws/devel/include;/home/olumide/TDDE05/catkin_ws/src/rosplan/rosplan_dependencies/VAL/include;/home/olumide/TDDE05/catkin_ws/src/rosplan/rosplan_dependencies/rddl_parser;/home/olumide/TDDE05/catkin_ws/src/rosplan/rosplan_dependencies/ippc_server/include;/home/olumide/TDDE05/catkin_ws/src/rosplan/rosplan_dependencies/ippc_server/cpp-base64;/home/olumide/TDDE05/catkin_ws/src/rosplan/rosplan_dependencies/ppddl_parser/include;/home/olumide/TDDE05/catkin_ws/src/rosplan/rosplan_dependencies/ppddl_parser/src;/opt/ros/kinetic/include;/opt/ros/kinetic/share/xmlrpcpp/cmake/../../../include/xmlrpcpp;/usr/include " STREQUAL " ")
  set(rosplan_planning_system_INCLUDE_DIRS "")
  set(_include_dirs "/home/olumide/TDDE05/catkin_ws/src/rosplan/rosplan_planning_system/include;/home/olumide/TDDE05/catkin_ws/devel/include;/home/olumide/TDDE05/catkin_ws/src/rosplan/rosplan_dependencies/VAL/include;/home/olumide/TDDE05/catkin_ws/src/rosplan/rosplan_dependencies/rddl_parser;/home/olumide/TDDE05/catkin_ws/src/rosplan/rosplan_dependencies/ippc_server/include;/home/olumide/TDDE05/catkin_ws/src/rosplan/rosplan_dependencies/ippc_server/cpp-base64;/home/olumide/TDDE05/catkin_ws/src/rosplan/rosplan_dependencies/ppddl_parser/include;/home/olumide/TDDE05/catkin_ws/src/rosplan/rosplan_dependencies/ppddl_parser/src;/opt/ros/kinetic/include;/opt/ros/kinetic/share/xmlrpcpp/cmake/../../../include/xmlrpcpp;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'rosplan_planning_system' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'rosplan_planning_system' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/olumide/TDDE05/catkin_ws/src/rosplan/rosplan_planning_system/${idir}'.  ${_report}")
    endif()
    _list_append_unique(rosplan_planning_system_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "rosplan_action_interface")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${rosplan_planning_system_dep}_FOUND)
      find_package(${rosplan_planning_system_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${rosplan_planning_system_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
